        ...
        <div>
            <AppBar className={classes.nav}>
                <Toolbar>
                    ...
                    <Button component={Link} to="/register" className={classes.navBtn}>Register</Button>
                    <Button component={Link} to="/login" className={classes.navBtn}>Login</Button>
                </Toolbar>
            </AppBar>
        </div>
...
export default withStyles(styles)(LogoutM)